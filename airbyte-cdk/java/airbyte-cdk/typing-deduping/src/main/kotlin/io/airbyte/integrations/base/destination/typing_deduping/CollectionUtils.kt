...
object CollectionUtils {
    ...
    fun containsIgnoreCase(collection: Collection<String>, search: String): Boolean {
        return matchingKey(collection, search) != null
    }
     ...
     */
    fun matchingKey(collection: Collection<String>, search: String): String? {
        if (collection.contains(search)) {
            return search
        }
        return collection.firstOrNull { it.equals(search, ignoreCase = true) }
    }
}
